...
Usage:
    python ds_ocr_fetch.py <parent_dir> <field>

Examples:
    python ds_ocr_fetch.py ../data/aiml aiml
    python ds_ocr_fetch.py ../data/neuroscience neuroscience
    python ds_ocr_fetch.py ../data/neuromorphic neuromorphic
"""
...
# LLM_MODEL = "llama3.3-70b-ollama"
client = OpenAI(
    base_url="http://carz1.ornl.gov:11434/v1",
    # base_url="http://carz3.ornl.gov:11434",
    api_key="ollama",
)
